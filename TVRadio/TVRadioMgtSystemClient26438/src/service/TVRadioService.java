...
public interface TVRadioService extends Remote {
    // User / Session
    String loginRequest(String username, String password) throws RemoteException;

    model.Session loginConfirm(String username, String otp) throws RemoteException;
